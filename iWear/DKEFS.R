...
df_iWear <- read.csv("HDIWear_DATA_2018-10-22.csv", stringsAsFactors=FALSE, na.strings=c("",NA))
...
write.csv(df_dkefs, "dkefs_equality_0305.csv", row.names = F)
...
write.csv(df_dkefs, "dkefs_crr.csv", row.names = F)