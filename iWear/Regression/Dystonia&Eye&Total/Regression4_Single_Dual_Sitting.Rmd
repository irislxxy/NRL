---
title: "Regression on Single + Dual + Sitting"
output: pdf_document
---
...
```{r}
## Fit the full model
full.mod_dystonia <- lm(Dystonia_Subscore ~ Jerk_Standing_A + Mean_Velocity_Standing_A + Sway_Area_Standing_A + Jerk_Standing_T + Mean_Velocity_Standing_T + Jerk_Standing_A2 + Mean_Velocity_Standing_T2 + Sway_Area_Standing_T2 + Jerk_Sitting + Mean_Velocity_Sitting, data = df)
...
```{r}
## Fit the full model
full.mod_chorea_eye <- lm(Chorea_Eye_Subscore ~ Jerk_Standing_A + Mean_Velocity_Standing_A + Sway_Area_Standing_A + Jerk_Standing_T + Mean_Velocity_Standing_T + Jerk_Standing_A2 + Mean_Velocity_Standing_T2 + Sway_Area_Standing_T2 + Jerk_Sitting + Mean_Velocity_Sitting, data = df)

## Stepwise regression model
step.mod_chorea_eye <- stepAIC(full.mod_chorea_eye, direction = "both", trace = FALSE)
summary(step.mod_chorea_eye)
```
### The best model is Chorea_Eye_Subscore ~ Mean_Velocity_Standing_A + Jerk_Standing_T + Mean_Velocity_Standing_T + Jerk_Standing_A2 + Mean_Velocity_Standing_T2 + Sway_Area_Standing_T2.
...
```{r}
## Fit the full model
full.mod_chorea_total <- lm(Chorea_Total_Subscore ~ Jerk_Standing_A + Mean_Velocity_Standing_A + Sway_Area_Standing_A + Jerk_Standing_T + Mean_Velocity_Standing_T + Jerk_Standing_A2 + Mean_Velocity_Standing_T2 + Sway_Area_Standing_T2 + Jerk_Sitting + Mean_Velocity_Sitting, data = df)

## Stepwise regression model
step.mod_chorea_total <- stepAIC(full.mod_chorea_total, direction = "both", trace = FALSE)
summary(step.mod_chorea_total)
```
### The best model is Chorea_Total_Subscore ~ Mean_Velocity_Standing_A + Sway_Area_Standing_A + Mean_Velocity_Standing_T + Jerk_Standing_A2 + Jerk_Sitting.