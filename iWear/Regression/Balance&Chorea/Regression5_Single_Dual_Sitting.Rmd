...
```{r}
## Fit the full model
full.mod_balance <- lm(Balance_Subscore ~ Jerk_Standing_A + Mean_Velocity_Standing_A + Sway_Area_Standing_A + Mean_Velocity_Standing_T + Sway_Area_Standing_T + Jerk_Standing_A2 + Sway_Area_Standing_A2 + Mean_Velocity_Standing_T2 + Sway_Area_Standing_T2 + Jerk_Sitting + Mean_Velocity_Sitting, data = df)

## Stepwise regression model
step.mod_balance <- stepAIC(full.mod_balance, direction = "both", trace = FALSE)
summary(step.mod_balance)
```
### The best model is Balance_Subscore ~ Jerk_Standing_A.
...
```{r}
## Fit the full model
full.mod_chore <- lm(Chore_Subscore ~ Jerk_Standing_A + Mean_Velocity_Standing_A + Sway_Area_Standing_A + Mean_Velocity_Standing_T + Sway_Area_Standing_T + Jerk_Standing_A2 + Sway_Area_Standing_A2 + Mean_Velocity_Standing_T2 + Sway_Area_Standing_T2 + Jerk_Sitting + Mean_Velocity_Sitting, data = df)

## Stepwise regression model
step.mod_chore <- stepAIC(full.mod_chore, direction = "both", trace = FALSE)
summary(step.mod_chore)
```
### The best model is Chore_Subscore ~ Sway_Area_Standing_A + Jerk_Standing_A2 + Jerk Sitting.